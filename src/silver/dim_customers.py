# dim_customers — Managed Ingestion (Lakeflow Connect)
#
...
# from an external source directly into ws_dbxprojectrc.02_silver.dim_customers.
#
# Schema (02_silver.dim_customers):
#   customer_id  STRING
#   name         STRING
#   email        STRING
#   city         STRING
